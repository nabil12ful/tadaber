...
@section('title', 'طلبات نقل خدمات الأرشيف - محمد عبده العسيري (تدابير)')

@section('content')


    <main id="primary" class="site-main allsponsorcvs">


        <header class="page-header">
            <div class="container">
                <h1 class="page-title">طلبات نقل خدمات</h1>
            </div>
        </header>
        <div class="container">
                ...
                @forelse ($items as $item)
                    <div class="col-md-4">
                        <div class="item mb-4 mb-md-0">
                            <a class="image" href="{{ asset('uploads/worker/' . $item->image) }}" data-fancybox><img
                                    width="1241" height="1755" src="{{ asset('uploads/worker/' . $item->image) }}"
                            ...
                            <div class="text-center">
                                <a class="btn btn-warning"
                                    href="https://api.whatsapp.com/send?phone={{ env('PHONE_NUMBER') }}">حجز
                                    السيرة الذاتية</a>
                            </div>
                        </div>
                    </div>
